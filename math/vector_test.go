...
func TestVector3Add(t *testing.T) {
	...
	if !FloatsEqual(v2[0], 0.0) || !FloatsEqual(v2[1], 1.0) || !FloatsEqual(v2[2], 7.0) {
		t.Errorf("Add modified an original vector while calculating addition: %v", v2)
	}
	if !FloatsEqual(v1[0], 1.0) || !FloatsEqual(v1[1], 3.5) || !FloatsEqual(v1[2], 10.75) {
	...
	if !FloatsEqual(v2[0], 1.0) || !FloatsEqual(v2[1], 4.5) || !FloatsEqual(v2[2], 17.75) {
...
func TestVector3AddScaled(t *testing.T) {
	...
	if !FloatsEqual(v1[0], 1.0) || !FloatsEqual(v1[1], 5.5) || !FloatsEqual(v1[2], 24.75) {
...
func TestVector3Clear(t *testing.T) {
	...
	if !FloatsEqual(v1[0], 0.0) || !FloatsEqual(v1[1], 0.0) || !FloatsEqual(v1[2], 0.0) {
...
func TestVector3ComponentProduct(t *testing.T) {
	...
	if !FloatsEqual(v1[0], 0.0) || !FloatsEqual(v1[1], 2.5) || !FloatsEqual(v1[2], 24.5) {
...
func TestVector3Cross(t *testing.T) {
	...
	if !FloatsEqual(v1[0], 1.0) || !FloatsEqual(v1[1], 2.0) || !FloatsEqual(v1[2], 3.0) {
		t.Errorf("Cross modified an original vector while calculating a cross product: %v", v1)
	}
	if !FloatsEqual(v2[0], 10.0) || !FloatsEqual(v2[1], 11.0) || !FloatsEqual(v2[2], 12.0) {
		t.Errorf("Cross modified an original vector while calculating a cross product: %v", v1)
	}
	if !FloatsEqual(v3[0], -9.0) || !FloatsEqual(v3[1], 18.0) || !FloatsEqual(v3[2], -9.0) {
...
func TestVector3Dot(t *testing.T) {
	...
	if !FloatsEqual(v1[0], -1.0) || !FloatsEqual(v1[1], -5.0) || !FloatsEqual(v1[2], -7.0) {
		t.Errorf("Dot modified an original vector while calculating a dot product: %v", v1)
	}
	if !FloatsEqual(v2[0], 10.0) || !FloatsEqual(v2[1], 20.0) || !FloatsEqual(v2[2], 30.0) {
		t.Errorf("Dot modified an original vector while calculating a dot product: %v", v1)
	}
	if !FloatsEqual(dot, -320.0) {
...
func TestVector3Magnitude(t *testing.T) {
	...
	if !FloatsEqual(v1[0], 2.0) || !FloatsEqual(v1[1], -5.0) || !FloatsEqual(v1[2], 4.0) {
		t.Errorf("Magnitude modified an original vector while calculating a magnitude: %v", v1)
	}
	if !FloatsEqual(mag, 6.708203932499369) {
...
func TestVector3SquareMagnitude(t *testing.T) {
	...
	if !FloatsEqual(sqmag, 4.0+25+16) {
...
func TestVector3MulWith(t *testing.T) {
	...
	if !FloatsEqual(v1[0], 10.0) || !FloatsEqual(v1[1], 25.0) || !FloatsEqual(v1[2], 35.0) {
...
func TestVector3Normalize(t *testing.T) {
	v1 := Vector3{1.0, 2.5, 3.5}
	v1.Normalize()
	if !FloatsEqual(v1.Magnitude(), 1.0) {
...
func TestVector3Set(t *testing.T) {
	...
	if !FloatsEqual(v1[0], 10.0) || !FloatsEqual(v1[1], 20.0) || !FloatsEqual(v1[2], 30.0) {
...
func TestVector3Sub(t *testing.T) {
	...
	if !FloatsEqual(v1[0], -11.0) || !FloatsEqual(v1[1], -25.0) || !FloatsEqual(v1[2], -37.0) {
...
func TestVector4MulWith(t *testing.T) {
	...
	if !FloatsEqual(v1[0], 10.0) || !FloatsEqual(v1[1], 25.0) || !FloatsEqual(v1[2], 35.0) || !FloatsEqual(v1[3], 987.0) {
		t.Errorf("MulWith isn't multiplying a vector properly: %v", v1)
	}
}
...
func TestVectorGoCopies(t *testing.T) {
	...
	if !FloatsEqual(vArray[0][0], 2.0) || !FloatsEqual(vArray[0][1], 5.0) || !FloatsEqual(vArray[0][2], 7.0) {
		t.Errorf("MulWith isn't multiplying a vector properly: %v", v1)
	}

	if !FloatsEqual(v1[0], 1.0) || !FloatsEqual(v1[1], 2.5) || !FloatsEqual(v1[2], 3.5) {
